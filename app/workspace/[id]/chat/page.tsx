        ...
        <div className="h-16 border-b border-border-green flex items-center px-6 justify-between shrink-0">
          ...
          <div className="flex items-center gap-3">
            <select
              ...
              className="bg-surface-highlight border border-border-green rounded-lg px-3 py-1.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
            >
          ...
          {messages.length === 0 ? (
            ...
            <>
              <div className="flex justify-center">
                <span className="text-xs text-text-dim bg-surface-highlight px-3 py-1 rounded-full">
                  오늘
                </span>
              </div>
                    ...
                    <div className="flex flex-col items-start gap-1">
                      <div className="flex items-end gap-3 max-w-[90%]">
                        ...
                        <div className="flex flex-col gap-2 items-start">
                          <span className="text-text-dim text-[12px] pl-1">
                            TermBot
                          </span>
          ...
          <div className="max-w-5xl mx-auto space-y-6">
              ...
              <div className="flex flex-col gap-2 rounded-xl p-5 border border-border-green bg-surface-dark relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white text-3xl font-bold">
                    {currentWorkspace?.documentCount || 0}
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-xl border border-border-green bg-surface-dark p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  onClick={() =>
                    setInput("가장 많이 사용된 용어 Top 10을 알려줘")
                  }
                ...
                <button
                  ...
                  className="p-4 rounded-lg bg-surface-highlight border border-border-green hover:border-primary hover:bg-primary/5 transition-all text-left"
                >
                  <span className="material-symbols-outlined text-purple-400 mb-2">
                    description
                  </span>
                ...
                <button
                  ...
                  className="p-4 rounded-lg bg-surface-highlight border border-border-green hover:border-primary hover:bg-primary/5 transition-all text-left"
                >
                  <span className="material-symbols-outlined text-blue-400 mb-2">
                    database
                  </span>
                ...
                <button
                  ...
                  className="p-4 rounded-lg bg-surface-highlight border border-border-green hover:border-primary hover:bg-primary/5 transition-all text-left"
                >
                  <span className="material-symbols-outlined text-yellow-400 mb-2">
                    schedule
                  </span>
